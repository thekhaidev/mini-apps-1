...
CREATE TABLE `customer` (
  ...
  `address1` VARCHAR(20) NULL DEFAULT NULL,
...
INSERT INTO `customer` (`id`,`name`,`email`,`password`,`cc`,`cc_exp`,`ccv`,`address1`,`address2`,`city`,`state`,`zip`, `billzip`) VALUES
('1','Key','Key123@gmail.com','123','123412341234','2012','123','1048 Church','','Victorville','CA','92301', '92301');